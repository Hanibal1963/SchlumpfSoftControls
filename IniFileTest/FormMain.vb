...
#Region "Ereignis des Formulars"

    Private Sub FormMain_Load(sender As Object, e As EventArgs) Handles Me.Load

        'Dateikommentar laden
        Me.FileCommentEdit.Comment = Me.IniFile1.GetFileComment

        'Abschnittsliste füllen
        Me.SectionsListEdit.Items = Me.IniFile1.GetSectionNames
...
#Region "Ereignisse des Menüs"
    ...
    Private Sub ToolStripMenuItem_Speichern_Click(sender As Object, e As EventArgs) Handles _
    ...
    Private Sub ToolStripMenuItem_SpeichernUnter_Click(sender As Object, e As EventArgs) Handles _
    ...
    Private Sub ToolStripMenuItem_Beenden_Click(sender As Object, e As EventArgs) Handles _
...
#Region "Ereignisse von IniFile"
    ...
    Private Sub IniFile1_FileContentChanged(sender As Object, e As EventArgs) Handles _
        IniFile1.FileContentChanged

        'Dateiinhalt anzeigen
        Me.IniFileContentView.Lines = CType(sender, IniFile).GetFileContent()

        'Dateikommentar laden
        Me.FileCommentEdit.Comment = CType(sender, IniFile).GetFileComment()

        'Abschnittsliste laden
        Me.SectionsListEdit.Items = CType(sender, IniFile).GetSectionNames()

    End Sub

    Private Sub IniFile1_SectionsChanged(sender As Object, e As EventArgs) Handles _
    ...
    Private Sub IniFile1_EntrysChanged(sender As Object, e As EventArgs) Handles _
        IniFile1.EntrysChanged

        'Eintragsliste neu befüllen
        Me.EntrysListEdit.Items = CType(sender, IniFile).GetEntryNames(Me.SectionsListEdit.SelectedItem)

    End Sub

    Private Sub IniFile1_SectionNameExist(sender As Object, e As EventArgs) Handles _
    ...
    Private Sub IniFile1_EntrynameExist(sender As Object, e As EventArgs) Handles _
    ...
    Private Sub IniFile1_FileCommentChanged(sender As Object, e As EventArgs) Handles _
    ...
    Private Sub IniFile1_SectionCommentChanged(sender As Object, e As EventArgs) Handles _
        ...
        Me.SectionsCommentEdit.Comment = CType(sender, IniFile).GetSectionComment(sectionname)
...
#Region "Ereignisse der Abschnittsliste"
    ...
    Private Sub SectionCommentEdit_CommentChanged(sender As Object, e As EventArgs) Handles _
        ...
        'geänderten Abschnittskommentar übernehmen
        Me.IniFile1.SetSectionComment(Me.SectionsListEdit.SelectedItem, comment)
    ...
    Private Sub SectionsListEdit_ItemRemove(sender As Object, e As EventArgs) Handles _
        ...
        'Abschnittsname holen
        Dim sectionname As String = CType(sender, IniFileListEdit).SelectedItem
    ...
    Private Sub SectionsListEdit_ItemRename(sender As Object, e As EventArgs) Handles _
        ...
        Else 'ansonsten ->
            ...
            'Abschnitt umbenennen
            Me.IniFile1.RenameSection(sectionname, newsection)
...
#Region "Ereignisse der Eintragsliste"

    Private Sub EntrysListEdit_ItemAdd(sender As Object, e As EventArgs) Handles _
        ...
        Else 'ansonsten ->
            ...
            'Eintrag hinzufügen
            Me.IniFile1.AddEntry(sectionname, newentry)

        End If

    End Sub

    Private Sub EntrysListEdit_ItemRemove(sender As Object, e As EventArgs) Handles _
        ...
        'Eintragsname holen
        Dim entryname As String = CType(sender, IniFileListEdit).SelectedItem
        ...
        If result = DialogResult.Yes Then Me.IniFile1.DeleteEntry(sectionname, entryname)

    End Sub

    Private Sub EntrysListEdit_ItemRename(sender As Object, e As EventArgs) Handles _
        ...
        'Eintrag umbenennen
        Me.IniFile1.RenameEntry(sectionname, entryname, newentry)

    End Sub

    Private Sub EntrysListEdit_SelectedItemChanged(sender As Object, e As EventArgs) Handles _
        ...
        Else 'ansonsten ->
            ...
            'Eintragswert setzen
            Me.EntryValueEdit.Value = Me.IniFile1.GetEntryValue(sectionname, entryname)

        End If

    End Sub

    Private Sub EntryValueEdit_ValueChanged(sender As Object, e As EventArgs) Handles _
        ...
        'Eintragswert holen
        Dim entryvalue As String = CType(sender, IniFileEntryValueEdit).Value
        ...
        Else 'ansonsten ->
            ...
            'Eintrag ändern
            Me.IniFile1.SetEntryValue(sectionname, entryname, entryvalue)
